  ...
  render() {
    return (
      <tr>
        ...
        <th className="text-center">
          <h6>
            {moment(this.props.row.APPOINT_TIME).format("YYYY-MM-DD hh:mm A")}
          </h6>
        </th>
      </tr>
    );
...
class ConsultingRoom extends React.Component {
  ...
  startarchiveVideo() {
    axios
      .post(
        "http://localhost:3000" + "/archive/start",
        {
          sessionId:
            "1_MX40NzI3NDA1NH5-MTYyNzUyMTEzNDA5NH5MYTRBV05oWTlsaXhVNWU1RjhWbTM4QjZ-UH4",
        },
        null,
        "json"
      )
      ...
      <div style={{ height: "100vh", alignItems: "center" }} className="mx-1 ">
        <Row style={{ backgroundColor: "white" }} className="mb-2 mt-1">
          ...
          <Col lg="3" md="12" className="d-flex justify-content-end">
            <div className="mr-1">
              <img
                className="pt-1"
                onClick={this.questionModal}
                style={{ width: "2rem", height: "3rem", cursor: "pointer" }}
                src={Question}
                alt="question"
              />
            </div>
        ...
        <Row className="d-flex justify-content-between mb-1">
          ...
          <Col lg="6" md="12" className="text-right">
            <Button className="mr-1" color="black" outline type="button">
              {/* 타이머 */}
              {this.props.appo === null ? (
            ...
            <div className="d-flex justify-content-between">
              ...
              <div style={{ width: "60%" }}>
                ...
                <Card className="mb-1" style={{ height: "90px" }}>
                  ...
                  <CardBody className="mt-0 pt-0">{file_preview}</CardBody>
                </Card>
