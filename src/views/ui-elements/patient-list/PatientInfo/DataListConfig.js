          ...
          <Row className="m-0">
            <Col className="col-4 m-0">
              <Card className="m-0" style={{height:"23rem"}} >
                ...
                <CardBody>
                  <Row>
                    <Col lg="3" md="12" className="align-self-center"><b>C.C:</b></Col>
                    <Col lg="9" md="12" className="align-self-center">{props.data.NOTE_CC}</Col>
                  </Row>
                  <Row className="mt-1">
                    <Col lg="3" md="12" className="align-self-center"><b>Diagnosis:</b></Col>
                    <Col lg="9" md="12" className="align-self-center">{props.data.NOTE_DX}</Col>
                  </Row>
                  <Row className="mt-1">
                    <Col lg="3" md="12" className="align-self-center"><b>Tx &#38; Rx: </b></Col>
                    <Col lg="9" md="12" className="align-self-center">{props.data.NOTE_RX}</Col>
                  </Row>
                  <Row className="mt-1">
                    <Col lg="3" md="12" className="align-self-center"><b>Recommendation:</b></Col>
                    <Col lg="9" md="12" className="align-self-center">{props.data.NOTE_VITAL}</Col>
                  </Row>
                </CardBody>
              </Card>
            </Col>
