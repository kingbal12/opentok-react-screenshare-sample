...
export const puthsinfo = (
  ...
  return (dispatch) => {
    axios
      .put("https://teledoc.hicare.net:446/v1/doctor/account/hospital-info", {
        user_id: userid,
        hospital_name: hospitalname,
        business_num: businessnumber,
        zip_code: zipcode,
...
export const register4 = (
  ...
  return (dispatch) => {
    axios
      .post("https://teledoc.hicare.net:446/v1/doctor/account/user-info", data)
      .then((response) => {
        let register4status;
...
export const changepassword = (userid, password, newpassword) => {
  return (dispatch) => {
    axios
      .put("https://teledoc.hicare.net:446/v1/doctor/account/password", {
        user_id: userid,
        user_pwd: password,
        new_pwd: newpassword,
      })
